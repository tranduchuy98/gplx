...
public extension Notification.Name {
    static let reachabilityChanged = Notification.Name(MConstants.NOTIFY_REACHABILITY_CHANGED)
}

public class MReachability {

    public typealias NetworkReachable = (MReachability) -> ()
    public typealias NetworkUnreachable = (MReachability) -> ()
    ...
    required public init(reachabilityRef: SCNetworkReachability,
        ...
        self.reachabilitySerialQueue = DispatchQueue(label: MConstants.DISPATCH_QUEUE_REACHABILITY, qos: queueQoS, target: targetQueue)
...
public extension MReachability {
...
fileprivate extension MReachability {
...
extension SCNetworkReachabilityFlags {
    ...
    typealias Connection = MReachability.Connection
...
private class ReachabilityWeakifier {
    weak var reachability: MReachability?
    init(reachability: MReachability) {
