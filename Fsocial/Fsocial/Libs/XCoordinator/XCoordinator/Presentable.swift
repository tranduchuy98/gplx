...
var mockRouter: WeakRouter<AppRoute> {
    WeakRouter(AppCoordinator()) { $0.strongRouter }
}
...
//        let observer = AnyObserver<[FlashCard]> {
//            print($0)
//        }
//
//        let vm = FlashCardViewModel(flashCardObserver: observer, router: mockRouter)
//        let hostVC = Inject.ViewControllerHost(FlashCardViewController.newInstance(with: vm))
//        window.rootViewController = hostVC
        
        window.rootViewController = viewController
        
//        let viewModel = FlashCardViewModel(with: mockRouter)
//        window.rootViewController = FlashCardViewController.newInstance(with: viewModel)
